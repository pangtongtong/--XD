...
public class  SelectStuInfoNameUI extends JFrame implements ActionListener{
	...
	public SelectStuInfoNameUI() {
		
		label = new JLabel("请输入要查询的学生姓名");
	...
	public void actionPerformed(ActionEvent event) {
		...
		if(event.getSource()==select_button) {
			try {
				SelectStuInfoName sel = new SelectStuInfoName();
