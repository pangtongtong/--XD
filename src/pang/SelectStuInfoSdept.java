...
public class SelectStuInfoSdept {
	private Connection connection;
	private Vector rows;
	private Vector columnNames;
	private boolean flag;
	public SelectStuInfoSdept() {
	...
	public Vector getRows(String Sno) throws SQLException {
		String sql = ("select Sno,student.Cno,Sname,Sage,Ssex from student,class where class.Cno=student.Cno and class.Mno=?");
